...
public class ViewPageIndicator extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    List<AVStarts> avStartGsons = new ArrayList<>();

    public void setTitles(List<AVStarts> avStartGsons) {
    ...
    private void generateTitleView() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            tv.setText(avStartGsons.get(i).getName());
            ...
            circleImageView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (viewPager != null) {
                        ...
                        onItenClickListener.setOnClickListener(avStartGsons.get(finalI).getName());
                    }
                }
            });
