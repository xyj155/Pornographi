...
import com.example.pornographic.gson.Asia;
...
public class HomeAsiaFragment extends BaseFragment {
    ...
    private List<Asia> comicAVList = new ArrayList<>();
    ...
    public void initView(View view) {
        ...
        final BmobQuery<Asia> comicAVBmobQuery = new BmobQuery<>();
        ...
        smlComic.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                ...
                comicAVBmobQuery.findObjects(new FindListener<Asia>() {
                    @Override
