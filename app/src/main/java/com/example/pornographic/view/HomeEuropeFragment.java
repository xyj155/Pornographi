...
import com.example.pornographic.gson.Eroupean;
...
public class HomeEuropeFragment extends BaseFragment {
    ...
    private List<Eroupean> comicAVList = new ArrayList<>();

    @Override
    public int initLayout() {
        return R.layout.fragment_home_eucope;
    }
    ...
    public void initView(View view) {
        ...
        final BmobQuery<Eroupean> comicAVBmobQuery = new BmobQuery<>();
        ...
        smlComic.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                ...
                comicAVBmobQuery.findObjects(new FindListener<Eroupean>() {
                    @Override
                    public void done(List<Eroupean> list, BmobException e) {
                        if (e == null) {
                            comicAVList.clear();
                            comicAVList.addAll(list);
                            verticalAVAdapterAdapter.replaceData(comicAVList);
                        } else {
                            ToastUtils.show("查询出错"+e.getMessage());
                        }
